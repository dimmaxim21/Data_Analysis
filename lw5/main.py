...
def preprocessing_for_artm(number_of_docs_as_collection_length=False, number_of_docs=10):
    data = pd.read_csv("E:/GitProjects/lab5/data/lenta_ru.csv")
    texts = data["text"]
    all_docs = ""
    ...
    for i in range(number_of_docs):
        ...
        all_docs += "\n"
    f = open("E:/GitProjects/lab5/data/lenta.txt", "w")
    f.write(all_docs)
    f.close()
...
def run():
    ...
    topics = 10
    batch_vectorizer = artm.BatchVectorizer(data_path="E:/GitProjects/lab5/data/lenta.txt", data_format="vowpal_wabbit",
